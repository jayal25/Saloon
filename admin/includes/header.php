...
{
            ?>
                 <a class="dropdown-item" href="view-appointment.html?viewid=<?php echo $result['bid'];?>">New appointment received from <?php echo $result['FirstName'];?> <?php echo $result['LastName'];?> (<?php echo $result['AptNumber'];?>)</a>
                 <hr />
<?php }} else {?>
    <a class="dropdown-item" href="all-appointment.html">No New Appointment Received</a>
        <?php } ?>
                 ...
                 <li>
                  <div class="notification_bottom">
                    <a href="new-appointment.html">See all notifications</a>
                  </div> 
                </li>
              </ul>
            </li> 
          ...
          <ul>
            <li class="dropdown profile_details_drop">
              ...
              <ul class="dropdown-menu drp-mnu">
                <li> <a href="change-password.html"><i class="fa fa-cog"></i> Settings</a> </li> 
