...
echo "<script>window.location.href='rejected-appointment.html'</script>";
          }
...
?>
                     ...
                     <?php } else { ?>
                      <td><?php  echo $row['Status'];?></td><?php } ?> 
                                         <td>
                                         	<a href="view-appointment.html?viewid=<?php echo $row['bid'];?>" class="btn btn-primary">View</a>
<a href="rejected-appointment.html?delid=<?php echo $row['bid'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
