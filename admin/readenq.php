...
echo "<script>window.location.href='readenq.html'</script>";
          }
                 ...
                 <td><?php echo $cnt;?></td>
                  ...
                  <td><?php  echo $row['FirstName'];?> <?php  echo $row['LastName'];?></td>
                                        ...
                                        <td>
                                         ...
                                         <td>
<a href="view-enquiry.html?viewid=<?php echo $row['ID'];?>" class="btn btn-primary">View</a>
<a href="readenq.html?delid=<?php echo $row['ID'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
                                         </td>
                </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
