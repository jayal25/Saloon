...
echo "<script>window.location.href='accepted-appointment.html'</script>";
          }
  ?>
<!DOCTYPE HTML>
<html>
...
?>
                     ...
                     <?php } else { ?>
                      <td><?php  echo $row['Status'];?></td><?php } ?> 
                                         <td><a href="view-appointment.html?viewid=<?php echo $row['bid'];?>" class="btn btn-primary">View</a>
<a href="accepted-appointment.html?delid=<?php echo $row['bid'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')">Delete</a></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
					</div>
				</div>
